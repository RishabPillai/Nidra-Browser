...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        back_btn.setIcon(QIcon('cil-arrow-left.png'))
        ...
        next_btn.setIcon(QIcon('cil-arrow-right.png'))
        ...
        reload_btn.setIcon(QIcon('cil-reload.png'))
        ...
        home_btn.setIcon(QIcon('cil-home.png'))
        ...
        stop_btn.setIcon(QIcon('cil-media-stop.png'))
        ...
        self.setWindowTitle("Nidra Browser")
    ...
    def navigate_to_url(self):  # Does not receive the Url
        ...
        history.append(self.urlbar.text())
        print(history)
        if q.scheme() == "":
